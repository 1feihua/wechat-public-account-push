export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wx811d864029024650",

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "c628e0ee5342fd27e4d40b60cca30572",
  ...
  USERS: [
    {
      ...
      id: "oyFII6AqdJEA2ouQZafG3ENQah5o",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "	Ppy-gQJp-hELvNZqCv9MmmtTBMKTg5NmGphIL6jvQ7s	",
      // 所在省份
      province: "广东",
      // 所在城市
      city: "肇庆",
